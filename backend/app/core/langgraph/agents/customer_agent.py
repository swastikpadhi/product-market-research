...
class CustomerInsightsAgent:
    ...
    async def _search_customer_data(
        ...
        try:
            ...
            await progress_tracker.complete_checkpoint(request_id, "customer_search_started")
            ...
            if search_results:
                await progress_tracker.complete_checkpoint(request_id, "customer_search_completed")
            ...
            if urls_to_extract:
                ...
                if extracted_data:
                    await progress_tracker.complete_checkpoint(request_id, "customer_extraction_completed")
    ...
    async def _analyze_customer_data(
        ...
        try:
            ...
            customer_data = self._prepare_data_for_analysis(search_results, request_id)
            ...
            if analysis and not analysis.get("error"):
                await progress_tracker.complete_checkpoint(request_id, "customer_analysis_completed")
